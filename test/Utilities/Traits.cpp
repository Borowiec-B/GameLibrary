...
TEMPLATE_TEST_CASE("IsString holds true for types implemented to be considered string.", "[traits]",
...
TEMPLATE_TEST_CASE("IsString holds false for not-string types", "[traits]", int, struct Dummy*, char, wchar_t)
{
	REQUIRE_FALSE(IsString<TestType>::value);
	REQUIRE_FALSE(IsStringV<TestType>);
}

TEMPLATE_TEST_CASE("IsArithmeticOrString holds true for arithmetic or string types.", "[traits]",
...
TEMPLATE_TEST_CASE("IsArithmeticOrString holds false for not-arithmetic-or-string types.", "[traits]",
